...
- Abstract submission deadline: ~~May 5, 2025~~ May 10, 2025 (extended!)
- Notification: ~~May 15, 2025~~ May 21, 2025 (extended!)
...
Abstracts should be written in English (1-2 pages), and prepared using the [EasyChair style](https://easychair.org/publications/for_authors). The abstracts should be uploaded to the [WiL 2025 EasyChair page](https://easychair.org/my/conference?conf=wil2025) as a PDF file before the submission deadline on **May 5, 2025**, anywhere on Earth.
...
Applications should be sent by **May 17, 2025** via [this form](https://forms.gle/hSnTGEEddPZRYqqx5). The award notification date is May 19, 2025.
